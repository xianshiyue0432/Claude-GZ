...
export type ClientMessage =
  ...
  | { type: 'set_runtime_config'; providerId: string | null; modelId: string; enabledSkills?: string[]; enabledMcpServers?: string[]; enabledAgents?: string[]; enabledPlugins?: string[] }

...
export const zh: Record<TranslationKey, string> = {
  ...
  // Terminal Page
  'terminal.title': '终端',
  'terminal.description': '直接运行宿主机命令，用于安装插件、Skills、MCP 等需要命令行的扩展。',
  'terminal.newTerminal': '新建终端',
  'terminal.clear': '清屏',
  'terminal.restart': '重启',
  'terminal.windowTitle': '宿主机 Shell',
  'terminal.unavailableTitle': '需要桌面端运行时',
  'terminal.unavailableBody': '请在打包后的桌面端里打开这个页面，才能启动交互式终端。',
  ...
  'chat.plugins': '插件',
  'chat.terminal': '终端',
  'chat.toolAutoAllow': '勾选后自动允许该工具',
  'chat.toolDeselectAll': '取消全选',
  'chat.skillSelectHint': '选择要启用的技能',
  'chat.noSkills': '暂无可用技能',
  'chat.noTools': '暂无可用工具',
  'chat.mcpSelectHint': '选择要启用的 MCP 服务',
  'chat.noMcp': '暂无 MCP 服务',
  'chat.agentSelectHint': '选择要启用的 Agent',
  'chat.noAgents': '暂无可用 Agent',
  'chat.pluginSelectHint': '选择要启用的插件',
  'chat.noPlugins': '暂无可用插件',

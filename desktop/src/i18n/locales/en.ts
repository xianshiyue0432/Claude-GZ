export const en = {
  ...
  'sidebar.openSaveDir': 'Open Save Directory',
  ...
  'terminal.description': 'Run host commands directly for installing plugins, Skills, MCP and other command-line extensions.',
  'terminal.newTerminal': 'New Terminal',
  'terminal.clear': 'Clear',
  'terminal.restart': 'Restart',
  'terminal.windowTitle': 'Host Shell',
  'terminal.unavailableTitle': 'Desktop Runtime Required',
  'terminal.unavailableBody': 'Please open this page in the packaged desktop app to use the interactive terminal.',
  ...
  'chat.toolAutoAllow': 'Check to auto-allow this tool',
  'chat.toolDeselectAll': 'Deselect all',
  'chat.skillSelectHint': 'Select skills to enable',
  'chat.noSkills': 'No skills available',
  'chat.noTools': 'No tools available',
  'chat.mcpSelectHint': 'Select MCP servers to enable',
  'chat.noMcp': 'No MCP servers available',
  'chat.agentSelectHint': 'Select agents to enable',
  'chat.noAgents': 'No agents available',
  'chat.pluginSelectHint': 'Select plugins to enable',
  'chat.noPlugins': 'No plugins available',
  ...
  'slash.help.subtitle': 'Run agent workflows, view session status, or open desktop panels.',
  ...
  'slash.help.moreAvailable': '{count} more commands available. Type / to search the full list.',
  ...
  'slash.inspector.error.noActiveSession': 'No active session currently selected.',
  'slash.inspector.error.unavailable': 'Session inspector data unavailable. Please restart the desktop backend to enable the /api/sessions/:id/inspection endpoint.',
  ...
  'slash.inspector.usage.emptyBody': 'Usage will appear here after the CLI session starts and completes at least one turn.',
  'slash.inspector.usage.contextSnapshotNotice': 'Currently showing token usage from context snapshot. Will sync after context refresh.',
  'slash.inspector.usage.transcriptNotice': 'Currently showing usage reconstructed from session transcript. API duration only available for running CLI processes.',
  'slash.inspector.usage.unknownCost': 'Some model prices unknown; cost estimates may be inaccurate.',
  ...
  'slash.inspector.usage.byModel': 'By Model',
  'slash.inspector.usage.tokens': 'Tokens',
  'slash.inspector.usage.noModelTitle': 'No model usage yet',
  'slash.inspector.usage.noModelBody': 'Token usage will appear here after model responses are recorded.',
  'slash.inspector.context.loading': 'Loading context data',
  'slash.inspector.context.emptyTitle': 'No context data',
  ...
  'slash.inspector.context.categoryTitle': 'Estimated by Category',
  'slash.inspector.context.noCategoriesTitle': 'No context categories',
  'slash.inspector.context.noCategoriesBody': 'Category data will appear here after CLI returns context analysis.',
  ...
  'tabs.rename': 'Rename',
  'tabs.renameTitle': 'Rename Conversation',
